...
const StandsStrasbourg = () => {
  ...
  return (
    <>
  <ScrollView>
    <View style={[styles.standsStrasbourg, styles.iconLayout]}>
        <View style={[styles.standsStrasbourgChild, styles.standsLayout]} />
          ...
          <View style={[styles.cardFooter1, styles.cardSpaceBlock]}>
            <View style={styles.tagdarkenParent}>
              <View style={styles.tagdarkenFlexBox}>
                <Text style={[styles.abstract1, styles.abstract1Typo]}>
                  Abstract
                </Text>
              </View>
            ...
            <View style={[styles.frameParent, styles.thereSpaceBlock]}>
              <View style={styles.iconsexternallinkParent}>
                ...
                />
                <Text style={[styles.visiterLeSite1, styles.abstract1Typo]}>
                  Visiter le site
                </Text>
              </View>
              <View style={styles.iconsexternallinkParent}>
        ...
        <View
          style={[
            styles.menualt2outlineParent,
            styles.standsStrasbourgItemPosition,
          ]}
        >
          <Pressable
