  ...
  <ScrollView>
    <View style={styles.planDevenementNanncy}>
        ...
        <View style={styles.menualt2outlineParent}>
          ...
          <Text style={styles.planDevenement}>{`plan d’evenement
`}</Text>
        </View>
        <View style={styles.planDevenementNanncyChild} />
      </View>
...
export default PlanDevenementNanncy;
