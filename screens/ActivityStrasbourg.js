...
const ActivityStrasbourg = () => {
  ...
  return (
    <>
  <ScrollView>
    <View style={[styles.activityStrasbourg, styles.iconsdarkfilterLayout]}>
        <View style={[styles.menualt2outlineParent, styles.parentFlexBox]}>
          ...
          <Text style={styles.activits}>{`activités

`}</Text>
          <View style={styles.searchoutline}>
            <View style={styles.buttondarken}>
              <Image
                style={[styles.iconsdarkfilter, styles.iconsdarkfilterLayout]}
                contentFit="cover"
        ...
        <View style={styles.activityStrasbourgChild} />
        <Pressable
