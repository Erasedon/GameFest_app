...
const PlanningNancy = () => {
  ...
  return (
    <>
  <ScrollView>
    <View style={styles.planningNancy}>
        <View style={[styles.planningNancyInner, styles.planningLayout]}>
        ...
        <View style={[styles.planningNancyChild, styles.planningLayout]}>
          <View style={[styles.path2Parent, styles.path2ParentPosition]}>
            <Image
              style={[styles.path2Icon, styles.path2ParentPosition]}
              contentFit="cover"
...
`}</Text>
        ...
        <View style={styles.planningNancyItem} />
      </View>
